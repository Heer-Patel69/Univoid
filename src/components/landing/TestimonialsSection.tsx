      ...
      <div className="relative p-6 bg-card rounded-2xl border border-border shadow-lg hover:shadow-xl transition-all duration-300">
        ...
        <div className="pt-2">
          ...
          <div className="flex items-center gap-3 mb-4">
            <motion.img src={testimonial.avatar} alt={testimonial.name} className="w-12 h-12 rounded-full bg-muted border-2 border-border" whileHover={{
            scale: 1.1,
            rotate: 5
          }} />
            <div>
...
export const TestimonialsSection = () => {
  return <section className="py-20 px-4 bg-secondary/30 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        once: true
          ...
          <motion.span className="inline-block text-4xl mb-4" animate={{
          rotate: [0, 10, -10, 0]
        }} transition={{
          repeat: Infinity,
          duration: 2
