    ...
    <div className="space-y-4 mb-8">
      ...
      <div className="relative max-w-md">
        ...
        <Input
          ...
          className="pl-11 h-12 rounded-full border-2 border-foreground bg-card focus:ring-0"
      ...
      <div className="flex flex-wrap gap-2">
        <Select value={filters.course || 'all'} onValueChange={(v) => updateFilter('course', v)}>
          <SelectTrigger className="w-auto min-w-[120px] h-10 rounded-full border-2 border-foreground bg-card hover:bg-foreground hover:text-background transition-colors">
        ...
        <Input
          placeholder="Subject..."
          className="w-[140px] h-10 rounded-full border-2 border-foreground bg-card"
